...
namespace HelloApp1
{
    ...
    class TextCreat
    {
        ...
        {
            string path = @"C:\Users\Ivan\source\repos\ConsoleApp2";
        ...
        {
            string pathFile = @"C:\Users\Ivan\source\repos\ConsoleApp2";
    ...
    class JsonText
    {
        public void Json()
        {
            string path_one = @"C:\Users\Ivan\source\repos\ConsoleApp2\user.json";
        ...
        {
            string pathFileJson = @"C:\Users\Ivan\source\repos\ConsoleApp2\user.json";
    ...
    class TextXML
    {
        public void xml()
        {
            ...
            FileXML.Save(@"C:\Users\Ivan\source\repos\ConsoleApp2\user_xml.xml");
        ...
        {
            string pathFileXML = @"C:\Users\Ivan\source\repos\ConsoleApp2\user_xml.xml";
    ...
    class zip
    {
        ...
        {
            string path_to_folder = @"C:\Users\Ivan\source\repos\ConsoleApp2\archive_folder";
            string archive_path = @"C:\Users\Ivan\source\repos\ConsoleApp2\archive.zip";
        ...
        a1: switch (ans)
                ...
                case "1":
                    {
                        ...
                        {
                            const string pathFileToAdd = @"C:\Users\Ivan\source\repos\ConsoleApp2\note.txt";
                ...
                case "2":
                    {
                        using (ZipArchive zipArchive = ZipFile.Open(archive_path, ZipArchiveMode.Update))
                        {
                            const string pathFileToAdd = @"C:\Users\Ivan\source\repos\ConsoleApp2\user_xml.xml";
                ...
                case "3":
                    {
                        using (ZipArchive zipArchive = ZipFile.Open(archive_path, ZipArchiveMode.Update))
                        {
                            const string pathFileToAdd = @"C:\Users\Ivan\source\repos\ConsoleApp2\user_json.json";
            ...
            if (ans == "1")
            {
                FileInfo file = new FileInfo(@"C:\Users\Ivan\source\repos\ConsoleApp2\note.txt");
                Console.WriteLine($"Длина файла: {file.Length}");
            }
            else if (ans == "2")
            {
                FileInfo file = new FileInfo(@"C:\Users\Ivan\source\repos\ConsoleApp2\user_xml.xml");
                Console.WriteLine($"Длина файла: {file.Length}");
            }
            else if (ans == "3")
            {
                FileInfo file = new FileInfo(@"C:\Users\Ivan\source\repos\ConsoleApp2\user_json.json");
                Console.WriteLine($"Длина файла: {file.Length}");
            }
        ...
        {
            string pathFiletxt = @"C:\Users\Ivan\source\repos\ConsoleApp2\note.txt";
            string pathFilexml = @"C:\Users\Ivan\source\repos\ConsoleApp2\user_xml.xml";
            string pathFilejson = @"C:\Users\Ivan\source\repos\ConsoleApp2\user_json.json";
            string pathFilezip = @"C:\Users\Ivan\source\repos\ConsoleApp2\archive.zip";
            ...
            Directory.Delete(@"C:\Users\Ivan\source\repos\ConsoleApp2\archive_folder", true);
        }
    }
